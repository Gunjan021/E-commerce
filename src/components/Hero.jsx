...
function Hero() {
  return (
    <div
      className="flex flex-col px-5 md:px-80 justify-center items-center h-screen w-full bg-cover bg-no-repeat"
      style={{
        backgroundImage: `url(
    ...
    >
      <div className="text-5xl font-bold">Groceries Delivered in 90 Minute</div>
